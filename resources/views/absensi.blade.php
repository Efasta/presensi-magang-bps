                                                ...
                                                <ul class="space-y-2 mb-2">
                                                    <li class="flex items-center">
                                                        <input id="status-{{ Str::slug($status->nama) }}"
                                                            type="checkbox" name="status[]" value="{{ $status->nama }}"
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr data-status="{{ strtolower($user->absensi->status->nama) }}"
                                    ...
                                    <td class="px-4 py-3 max-w-[12rem] truncate">{{ $user->absensi->jam_masuk }}</td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">{{ $user->absensi->jam_keluar }}</td>
                                    ...
                                    <td class="px-4 py-3 max-w-[12rem] truncate">{{ $user->absensi->keterangan }}</td>
