                ...
                <div
                    ...
                    <div
                        ...
                        <div id="filterDropdown"
                            ...
                            <h6 class="mb-3 text-sm font-medium text-gray-900 dark:text-white">Pesan</h6>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Nama Pesan</th>
                                <th scope="col" class="px-4 py-3">Isi pesan</th>
                                <th scope="col" class="px-4 py-3">waktu pesan</th>
                        ...
                        <tbody>
                            @foreach ($notifs as $notif)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">{{ $notif->pesan }}i</td>
