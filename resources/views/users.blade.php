<x-layout :title="$title">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-self-end">
                                        ...
                                        <div id="users-{{ $user->id }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm"
                                                ...
                                                <li>
                                                    <a href="/profile" data-modal-target="updateProductModal"
                                                ...
                                                <li>
                                                    <a href="/profile?open_delete=1" data-mo dal-target="deleteModal"
    ...
    @else
        ...
        <div class="p-6 text-center text-gray-500">
            Anda tidak memiliki izin untuk melihat data users.
        </div>
    @endif
</x-layout>
