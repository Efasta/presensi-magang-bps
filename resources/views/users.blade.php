                ...
                <div class="bg-white dark:bg-gray-800 relative sm:rounded-lg">
                    <div
                            ...
                            <form method="GET" action="{{ route('users.index') }}" id="filterForm">
                                ...
                                <div
                                    ...
                                    <div id="filterDropdown"
                                        class="absolute z-10 hidden px-3 pt-1 bg-white rounded-lg shadow w-80 dark:bg-gray-700 right-4 top-15 max-h-73 overflow-y-auto">
                                        <div
                                            ...
                                            <div class="flex items-center space-x-3">
                                                <button type="submit" id="applyFilterButton"
                                                    class="cursor-pointer text-sm font-medium text-emerald-600 dark:text-emerald-500 hover:underline">
                                                    Terapkan
                                                </button>
                        ...
                        <div id="accordion-flush" data-accordion="collapse"
                            ...
                            <div id="jenis_kelamin-body" class="hidden" aria-labelledby="jenis_kelamin-heading">
                                <div class="py-2 font-light border-gray-300 dark:border-gray-600">

                                    @php
                                        $selectedJenisKelamin = (array) request()->input('jenis_kelamin');
                                    @endphp

                                    <ul class="space-y-2 mb-2">
                                        <li class="flex items-center">
                                            <input id="status-laki-laki" type="checkbox" name="jenis_kelamin[]"
                                                value="Laki-laki"
                                        ...
                                        <li class="flex items-center">
                                            <input id="status-perempuan" type="checkbox" name="jenis_kelamin[]"
                                                value="Perempuan"
                            ...
                            <div id="fungsi-body" class="hidden" aria-labelledby="fungsi-heading">
                                <div class="py-2 font-light border-gray-300 dark:border-gray-600">
                                    ...
                                    @foreach ($fungsis as $fungsi)
                                        <ul class="space-y-2 mb-2">
                                            <li class="flex items-center">
                                                <input id="fungsi-{{ Str::slug($fungsi->nama) }}" type="checkbox"
                                                    name="fungsi[]" value="{{ $fungsi->nama }}"
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody id="userTableBody">
                                ...
                                <td class="px-4 py-3 flex items-center">
                                    ...
                                    <div id="users-{{ $user->id }}-dropdown"
                                        ...
                                        <ul class="py-1 text-sm"
                                            ...
                                            <li>
                                                <a href="{{ route('users.show', ['user' => $user->slug, 'from' => 'users']) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-50 text-gray-500 italic">
